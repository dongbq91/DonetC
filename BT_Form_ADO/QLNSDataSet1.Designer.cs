...
namespace BT_Form_ADO {
    ...
    public partial class QLNSDataSet1 : global::System.Data.DataSet {
        ...
        public partial class DepartmentsDataTable : global::System.Data.TypedTableBase<DepartmentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DepartmentsRow AddDepartmentsRow(int DepartmentID, string Departmentname, string Descrition) {
            ...
            private void InitClass() {
                ...
                this.columnDescrition.MaxLength = 250;
            }
        ...
        public partial class DepartmentsRow : global::System.Data.DataRow {
            ...
            public string Descrition {
                get {
                    try {
                        return ((string)(this[this.tableDepartments.DescritionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Descrition\' in table \'Departments\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDepartments.DescritionColumn] = value;
                }
            }
            ...
            public bool IsDescritionNull() {
                return this.IsNull(this.tableDepartments.DescritionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDescritionNull() {
                this[this.tableDepartments.DescritionColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BT_Form_ADO.QLNSDataSet1TableAdapters {
    ...
    public partial class DepartmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Departments] WHERE (([DepartmentID] = @Original_DepartmentID) AND ((@IsNull_Departmentname = 1 AND [Departmentname] IS NULL) OR ([Departmentname] = @Original_Departmentname)) AND ((@IsNull_Descrition = 1 AND [Descrition] IS NULL) OR ([Descrition] = @Original_Descrition)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Departments] ([DepartmentID], [Departmentname], [Descrition]) " +
                "VALUES (@DepartmentID, @Departmentname, @Descrition);\r\nSELECT DepartmentID, Depa" +
                "rtmentname, Descrition FROM Departments WHERE (DepartmentID = @DepartmentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Departments] SET [DepartmentID] = @DepartmentID, [Departmentname] = @Departmentname, [Descrition] = @Descrition WHERE (([DepartmentID] = @Original_DepartmentID) AND ((@IsNull_Departmentname = 1 AND [Departmentname] IS NULL) OR ([Departmentname] = @Original_Departmentname)) AND ((@IsNull_Descrition = 1 AND [Descrition] IS NULL) OR ([Descrition] = @Original_Descrition)));
SELECT DepartmentID, Departmentname, Descrition FROM Departments WHERE (DepartmentID = @DepartmentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DepartmentID, Departmentname, Descrition FROM dbo.Departments";
        ...
        public virtual int Fill(QLNSDataSet1.DepartmentsDataTable dataTable) {
        ...
        public virtual QLNSDataSet1.DepartmentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLNSDataSet1.DepartmentsDataTable dataTable = new QLNSDataSet1.DepartmentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLNSDataSet1.DepartmentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_DepartmentID, string Original_Departmentname, string Original_Descrition) {
        ...
        public virtual int Insert(int DepartmentID, string Departmentname, string Descrition) {
        ...
        public virtual int Update(int DepartmentID, string Departmentname, string Descrition, int Original_DepartmentID, string Original_Departmentname, string Original_Descrition) {
            ...
            if ((Original_Descrition == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Descrition));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Departmentname, string Descrition, int Original_DepartmentID, string Original_Departmentname, string Original_Descrition) {
            return this.Update(Original_DepartmentID, Departmentname, Descrition, Original_DepartmentID, Original_Departmentname, Original_Descrition);
        }
    }
